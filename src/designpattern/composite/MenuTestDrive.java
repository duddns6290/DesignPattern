...
public class MenuTestDrive {
    public static void main(String[] args) {
        ...
        // adding items to PANCAKE HOUSE MENU
        ...
        dinerMenu.add(new MenuItem("Steamed Veggies and Brown Rice", "A medley of steamed vegetables over brown rice", true, 3.99));
